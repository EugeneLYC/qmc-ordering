...
from utils import train, validate, Timer, build_task_name, ImageFolderLMDB
...
def main():
    ...
    trainset = Dataset(dataset=ImageFolderLMDB(traindir),
                        train=True,
                        args=args)
    testset = Dataset(dataset=ImageFolderLMDB(valdir),
                        train=False,
                        args=args)
